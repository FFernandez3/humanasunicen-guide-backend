...
class SubjectServiceImplTest {
    ...
    void save_validRequest_returnSavedSubjectResponse() {
        ...
        Major major = new Major(1L, "Psicologia", "www.page.com", 2020, new ArrayList<>());
    ...
    void getSubjectsByMajorId_validId_returnListOfSubjects() {
        ...
        Major major = new Major(majorId, "Psicologia", "www.page.com", 2020, new ArrayList<>());

        Subject subject1 = new Subject("Didactica", 2, 1, List.of(major));
        Subject subject2 = new Subject("Historia", 3, 1, List.of(major));

        major.getSubjects().addAll(List.of(subject1, subject2));
